...
# @menu.manifest
# @item( main | 8 | 🔬 Рентген Xray ${C_CYAN}(Подключения, DDoS-детект)${C_RESET} | show_xray_scanner_menu | 32 | 2 | Анализ подключений к Xray: топ IP, детект аномалий, блокировка. )
#
